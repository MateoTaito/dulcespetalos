...
const About = () => {
    return (
        <section id="historia" className="py-24 bg-white relative overflow-hidden">
            {/* Decorative pattern */}
            <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-cream to-white" />
            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6 text-lg text-coffee/90 leading-relaxed">
                            <p>
                            ...
                            <p className="font-medium text-wood flex items-center gap-2">
            ...
            <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-cream to-white" />
        </section>
    );
};
